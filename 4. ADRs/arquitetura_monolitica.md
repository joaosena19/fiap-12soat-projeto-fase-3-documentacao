...
Contudo, como é requisito do Tech Challenge o uso de funções serveless, o fluxo de autenticação usa AWS Lambda. Mais detalhes em [todo: linkar adr do lambda].
